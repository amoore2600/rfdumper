...
* Add the 2 files linked above to the SD card on the largest partition in the "/retrofd" directory overwriting the 2 existing files (This will be the only partition Windows users can see)
